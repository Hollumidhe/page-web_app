...
const Navbar = () => {
  const [nav, setNav] = useState(false)
    ...
    return (
      ...
      <div className='w-screen h-[100px] z-10 bg bg-zinc-200 fixed drop-shadow-lg'>
        <div className='px-4 flex justify-between items-center w-full h-full  '>
          <div className='flex items-center'>
          <img className="w-20 ml-8" src={logoImg} alt="/" />
            {/* <h1 className='text-3xl font-bold mr-4 sm:text-4xl'>Hollumidhe.</h1> */}
          </div> 
          <div className=''> 
          ...
          <div className='hidden md:flex pr-4'>
            <button className='border-none bg-transparent text-black mr-6'>Sign In</button>
       ...
       <div className='flex flex-col my-4'>
        <button className='bg-transparent text-indigo-900 px-8 py-3 mb-4'>Sign In</button>
